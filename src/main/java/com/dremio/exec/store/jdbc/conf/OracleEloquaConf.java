...
@SourceType(value = "OracleEloquaARP", label = "OracleEloqua",uiConfig = "oracleeloqua-layout.json")
public class OracleEloquaConf extends AbstractArpConf<OracleEloquaConf> {
  private static final String ARP_FILENAME = "arp/implementation/oracleeloqua-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.oracleeloqua.OracleEloquaDriver";
